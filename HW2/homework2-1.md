```
db.Customer_embed.drop()
db.Customer.drop()
db.Order.drop()

db.createCollection("Customer_embed", {  
  "validator": {  
      $jsonSchema: {  
         bsonType: "object",  
         ...
         properties: {  
            ...
            order: {
               ...
               properties: {
                  ...
                  order_complete: {
                      bsonType: "bool",
                      description: "must be a boolean to indicate whether order is completed"
                      },
                  pickup_or_ship: {
                      enum: ["pickup","ship"],
                      description: "must be one of the value in enum if it exists"
                      }
                }
            }
         }
